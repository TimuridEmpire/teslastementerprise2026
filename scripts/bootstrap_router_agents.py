...
AGENTS = [
    ("CEO", "executive", 100, 100, ["CEO_PING", "CEO_CHAT", "CEO_REASONING_LOOP", "CEO_METRICS", "MINT_TOKENS", "BUDGET_APPROVAL", "MANAGER_INTERVENTION", "IMPLEMENT_FEATURE", "STRATEGY_REVIEW_RESULT", "ARTIFACT_PUBLISHED"]),
