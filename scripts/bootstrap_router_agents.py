...
AGENTS = [
    ...
    ("PM", "product", 80, 80, ["DEFINE_Q2_ROADMAP", "REQUEST_FEATURES", "CEO_STRATEGY_DIRECTIVE", "FEATURE_RESPONSE", "PM_REPORT", "MANAGER_INTERVENTION"]),
    ("Marketing", "marketing", 70, 70, ["LAUNCH_CAMPAIGN", "PM_REPORT", "BUDGET_ALERT", "THREAD_ALLOCATION", "MANAGER_INTERVENTION"]),
    ...
    ("Finance", "finance", 60, 60, ["BUDGET_APPROVAL", "GENERATE_PL_REPORT", "CASH_FLOW_FORECAST", "REVENUE_LOG", "AUDIT_REPORT", "MONTE_CARLO_SIM", "TOKEN_TOPUP_REQUEST", "TOKEN_BALANCE_QUERY", "PM_REPORT", "MANAGER_INTERVENTION"]),
